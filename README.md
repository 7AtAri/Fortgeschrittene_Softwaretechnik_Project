...
```
My DDD from Event Storming and a mapping with it's relations, as well as my Core Domain Chart is in the [DDD folder](https://github.com/7AtAri/Fortgeschrittene_Softwaretechnik_Project/tree/main/event%20storming:DDD).
